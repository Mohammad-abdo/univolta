                    ...
                    <tr key={app.id} className="border-b border-gray-50 hover:bg-[#FAFBFF] transition-colors">
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-montserrat-semibold text-[#121c67]">{app.university?.name || "—"}</p>
                            {app.university?.country && <p className="text-xs text-[#8b8c9a]">{app.university.country}</p>}
                          </div>
                        </div>
                      </td>
                      <td className="px-5 py-4 text-[#2e2e2e] font-montserrat-regular max-w-[200px]">{app.program?.name || "—"}</td>
                      <td className="px-5 py-4 text-[#65666f]">{app.program?.degree || "—"}</td>
                      <td className="px-5 py-4">
